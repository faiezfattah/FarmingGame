...
namespace Script.Feature.Input {
    public class InputProcessor : PlayerInput.IDefaultActions, IDisposable {
        ...
        private readonly Subject<Unit> _actionSubject = new();
        ...
        public Observable<Unit> ActionEvent => _actionSubject;
        ...
        public void OnAction(InputAction.CallbackContext context) {
            if (context.performed) _actionSubject.OnNext(Unit.Default);
        }
